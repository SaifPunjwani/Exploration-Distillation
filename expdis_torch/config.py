...
def parse_args():
    parser = argparse.ArgumentParser(description="Exploration-Distillation Scout/Central exploration with GRPO + RND (TPU-friendly).")
    ...
    parser.add_argument(
        ...
        help="Run only the baseline, the default Scout+Central (two_model) pipeline, or the reset-per-round multi-round pipeline.",
    )
