...
export EXPDIS_XLA_MARK_STEP_EVERY="${EXPDIS_XLA_MARK_STEP_EVERY:-1}"
export EXPDIS_XLA_FIXED_PADDING="${EXPDIS_XLA_FIXED_PADDING:-1}"
...
"$PYTHON_BIN" run_expdis_torch.py --device tpu \
