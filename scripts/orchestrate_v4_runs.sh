...
export TMX_DISTILL_MAX_TOTAL_LEN=4096
export TMX_DISTILL_EAGER_ATTN=1
...
export TMX_GRPO_USE_VLLM=0
export TMX_TRAJ_USE_VLLM=0
# Decoupled GRPO with on-device generation (no vLLM needed)
export TMX_EXPLORER_DECOUPLED_GRPO=1
export TMX_DECOUPLED_ONDEVICE_GEN_BATCH=2
