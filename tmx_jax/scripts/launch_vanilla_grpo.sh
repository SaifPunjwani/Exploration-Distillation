...
#
# Required env:
#   TMX_VLLM_SERVER_URLS=http://ip1:8000/v1,http://ip2:8000/v1,...
#
...
export TMX_ALLOW_LONG_COMPLETION_TRAIN="${TMX_ALLOW_LONG_COMPLETION_TRAIN:-1}"
...
# even if the cybernyc TPU dies. Same repo as codex; per-run namespace via PREFIX.
...
echo "  python -m tmx_jax.eval --model-name <hf_path_or_local_dir> --server-urls $VLLM_URLS"
