...
from tmx_jax.eval import aime24_wandb_metrics
...
def main() -> None:
    ...
    parser.add_argument("--project", default="two-model-explore")
    parser.add_argument("--run-id", default=os.environ.get("TMX_WANDB_RUN_ID", ""))
