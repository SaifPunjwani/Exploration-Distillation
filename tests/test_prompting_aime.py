...
class AimePromptingTests(unittest.TestCase):
    ...
    def test_aime_instruction_requests_boxed_answer(self):
    ...
    def test_normalizer_prefers_later_boxed_answer_over_early_number(self):
        ...
        self.assertEqual(normalized["completion_canonical"], "Final answer: 2")
        self.assertEqual(extract_presented_answer(raw), "2")
        self.assertEqual(canonicalize_completion_for_training(raw), "Final answer: 2")
    ...
    def test_normalizer_prefers_full_trace_answer_over_first_line_fraction(self):
        ...
        normalized = normalize_generated_completion(raw, answer_prefix="")
        self.assertEqual(normalized["completion_canonical"], "Final answer: 5")
        self.assertEqual(normalized["completion_scored"], "Final answer: 5")
    ...
    def test_numeric_answers_with_commas_are_preserved_and_canonicalized(self):
        ...
        self.assertEqual(canonicalize_completion_for_training(raw), "Final answer: 70000")
    ...
    def test_negative_decimal_answers_with_commas_score_correctly(self):
        ...
        self.assertEqual(canonicalize_completion_for_training(raw), "Final answer: -1250.5")
    ...
    def test_supervised_canonical_uses_answer_only_prompting(self):
        ...
        self.assertNotIn("Solve step by step.", rendered)
    ...
    def test_supervised_full_trace_uses_reasoning_prompting(self):
        ...
        self.assertNotIn("Do not use bullet points.", rendered)
