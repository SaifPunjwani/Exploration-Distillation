...
# Resolve the tested JAX/Flax stack and libtpu together. A second, unpinned
# install could otherwise upgrade JAX after installing its TPU plugin.
python -m pip install -r "$REPO_ROOT/expdis_jax/requirements.txt" \
