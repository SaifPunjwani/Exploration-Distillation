...
export EXPDIS_EXPECTED_TRAIN_ACCELERATOR="${EXPDIS_EXPECTED_TRAIN_ACCELERATOR:-v6e-64}"
...
export EXPDIS_FAST_PACKAGE_FANOUT="${EXPDIS_FAST_PACKAGE_FANOUT:-0}"
export EXPDIS_FAST_WORKER_SCRIPT_FANOUT="${EXPDIS_FAST_WORKER_SCRIPT_FANOUT:-0}"
