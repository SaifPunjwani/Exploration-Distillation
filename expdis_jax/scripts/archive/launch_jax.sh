...
#
# Usage:
#   EXPDIS_VLLM_SERVER_URLS=http://ip:8000/v1,http://ip2:8000/v1 \
#   RUN_NAME=explore_lambda0 \
#   bash expdis_jax/scripts/launch_jax.sh
set -euo pipefail
...
EXPDIS_DEBUG_COMPARE_LOGPROB_PATHS="${EXPDIS_DEBUG_COMPARE_LOGPROB_PATHS:-0}"
...
export EXPDIS_DEBUG_COMPARE_LOGPROB_PATHS
