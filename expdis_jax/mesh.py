...
Summary:
  ...
  * Activations: the GRPO step consumes rows one at a time (or small
    vectorized chunks); the Pallas attention in model.py runs with fully
    replicated specs, so activations are not head- or sequence-sharded.
